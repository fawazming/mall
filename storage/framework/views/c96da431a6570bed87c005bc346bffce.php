                ...
                <table class="order-list">
                    ...
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <a href="#" data-size="lg"
                                    data-url="<?php echo e(route('store.product.product_order_view', [$order_items->id, Auth::guard('customers')->user()->id, $store->slug])); ?>"
                                    data-title="<?php echo e($order_items->order_id); ?>" data-ajax-popup="true">
                                    <span class="btn-inner--text"><?php echo e($order_items->order_id); ?></span>
                            </td>
                            <td><?php echo e(\App\Models\Utility::dateFormat($order_items->created_at)); ?></td>
                            <td><?php echo e(\App\Models\Utility::priceFormat($order_items->price)); ?></td>
                            <td><?php echo e($order_items->payment_type); ?></td>
                            <td>
                                <?php if($order_items->status == 'pending'): ?>
                                    <span class="badge bg-warning rounded-pill">
                                        <?php echo e(__('Pending')); ?>:
                                        <?php echo e(\App\Models\Utility::dateFormat($order_items->created_at)); ?>

                                    </span>
                                <?php elseif($order_items->status == 'Cancel Order'): ?>
                                    <span class="badge bg-danger rounded-pill">
                                        <?php echo e(__('Order Canceled')); ?>:
                                        <?php echo e(\App\Models\Utility::dateFormat($order_items->created_at)); ?>
                            ...
                            <td>
                                <a href="#" class="ac-viewbtn"
                                    data-url="<?php echo e(route('store.product.product_order_view', [$order_items->id, Auth::guard('customers')->user()->id, $store->slug])); ?>"
                                    data-toggle="tooltip" class="view-btn order_view" data-title="<?php echo e(__('Your Order Details')); ?>"
                                   data-size="lg">
...
<?php else: ?>
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div
            class="tab-content <?php echo e($loop->iteration != 1 ? 'd-none' : 'active'); ?> <?php echo e($loop->iteration); ?><?php echo str_replace(' ', '_', $key); ?> product_tableese">
            <div class="tab-content-body">
                <div class="row o-gutters">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-sm-6 product-card product_item" data-name="<?php echo e($product->name); ?>">
                            <div class="product-card-inner">
                                <div class="product-card-image">
                                    <a href="#" class="" data-size="lg"
                                        data-url="<?php echo e($flag != 'my_orders' ? route('store.product.product_view', [$store->slug, $product->id]) : route('store.product.product_order_view', [$product->id, Auth::guard('customers')->user()->id, $store->slug])); ?>"
                                        data-title="<?php echo e($product->name); ?>" data-ajax-popup="true">
                                ...
                                <div class="product-content">
                                    <?php if(isset($product->categories)): ?>
                                        <span
                                            class="badge"><?php echo e(isset($product->categories) && !empty($product->categories) ? $product->categories->name : ''); ?></span>
                                    <?php endif; ?>
                                    ...
                                    <div class="product-content-top">
                                        <h5><a id="view" href="#" data-size="lg"
                                                ...
                                                data-ajax-popup="true"><?php echo e($product->name); ?></a></h5>
                                    ...
                                    <?php if($flag != 'my_orders'): ?>
                                        <?php if($product->enable_product_variant == 'on'): ?>
                                            <a href="#!" class="btn cart-btn btn-addcart modal-target"
                                                data-size="md"
                                                data-url="<?php echo e(route('store-variant.variant', [$store->slug, $product->id])); ?>"
                                                data-ajax-popup="true" data-title="<?php echo e(__('Add Variant')); ?>"
                                                data-name="custom-addcart" id="add_to_cart"><?php echo e(__('Add To Cart')); ?>
                                        ...
                                        <?php else: ?>
                                            <a href="#!" class="btn cart-btn btn-addcart add_to_cart"
                                                data-id="<?php echo e($product->id); ?>" id="add_to_cart"><?php echo e(__('Add To Cart')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\store\resources\views/storefront/theme7/grid.blade.php ENDPATH**/ ?>