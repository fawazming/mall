                ...
                <div class="col-xxl-4 col-md-6">
                    ...
                    <div class="d-flex gap-3 mt-4 banner-btn">
                        <?php if($settings['home_live_demo_link']): ?>
                            <a href="<?php echo e($settings['home_live_demo_link']); ?>" class="btn btn-outline-dark">Live
                                Demo <i data-feather="play-circle" class="ms-2"></i></a>
                        <?php endif; ?>
                        <?php if($settings['home_buy_now_link']): ?>
                            <a href="<?php echo e($settings['home_buy_now_link']); ?>" class="btn btn-outline-dark">Buy Now
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                <?php if($settings['discover_buy_now_link']): ?>
                    <a href="<?php echo e($settings['discover_buy_now_link']); ?>" class="btn btn-primary rounded-pill">Buy
    ...
    <section class="subscription bg-primary section-gap" id="plan">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <?php
                    // $collection = \App\Models\Plan::take(10)
                    // ->orderBy('price', 'ASC')
                    // ->get();
                ...
                <?php $__currentLoopData = $collection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card price-card shadow-none <?php echo e($adminSettings['cust_darklayout'] == 'off' ? ($key == 1 ? 'bg-light-primary' : ($key == 2 ? 'bg-dark' : '')) : 'bg-dark'); ?>">
                            <div class="card-body">
                                <span class="price-badge  bg-dark"><?php echo e($value->name); ?></span>
                                <span class="mb-4 f-w-600 display-3"><?php echo e((!empty($payment_setting['currency_symbol']) ? $payment_setting['currency_symbol'] : '$') . $value->price); ?><small
                                        class="text-sm">/<?php echo e($value->duration); ?></small></span>
                                
                                <?php if($value->trial == 'on'): ?>
                                    <p class="mb-0"><?php echo e(__('Free Trial Days : ')); ?><b><?php echo e($value->trial_days); ?></b></p>
                                <?php else: ?>
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <div class="form-check-label">
                                        <?php if($value->shipping_method == 'on'): ?>
                                            <span class="">
                                                <i class="text-primary ti ti-circle-plus"></i></span>
                                    ...
                                    <li>
                                        ...
                                        <?php if($value->storage_limit != '0'): ?>
                                            ...
                                            <?php else: ?>
                                                <?php echo e(__('Storage Limit : ')); ?><?php echo e($value->storage_limit); ?><?php echo e(' MB'); ?>
                                ...
                                <div class="row mb-3">
                                    <div class="col-4 text-center ">
                                        <?php if($value->max_products == '-1'): ?>
                                            <small
                                                class="mb-0 <?php echo e($key == 1 ? 'text-dark' : ''); ?> <?php echo e($key == 2 ? 'text-light-primary' : ''); ?> "><?php echo e(__('Unlimited')); ?></small>
                                        <?php else: ?>
                                            <b>
                                                <span
                                                    class="h5 mb-0 <?php echo e($key == 1 ? 'text-dark' : ''); ?> <?php echo e($key == 2 ? 'text-light-primary' : ''); ?>"><?php echo e($value->max_products); ?></span>
                                            </b>
                                        <?php endif; ?>
                                    ...
                                    <div class="col-4 text-center">
                                        <span class="mb-0">
                                            <?php if($value->max_stores == '-1'): ?>
                                                <small
                                                    class="mb-0 <?php echo e($key == 1 ? 'text-dark' : ''); ?> <?php echo e($key == 2 ? 'text-light-primary' : ''); ?> "><?php echo e(__('Unlimited')); ?></small>
                                            <?php else: ?>
                                                <span
                                                    class="h5 mb-0 <?php echo e($key == 1 ? 'text-dark' : ''); ?> <?php echo e($key == 2 ? 'text-light-primary' : ''); ?>"><?php echo e($value->max_stores); ?></span>
                                            <?php endif; ?>
                                        </span>
                                    ...
                                    <div class="col-4 text-center">
                                        <span class="mb-0">
                                            ...
                                            <?php else: ?>
                                                <span
                                                    class="h5 mb-0 <?php echo e($key == 1 ? 'text-dark' : ''); ?> <?php echo e($key == 2 ? 'text-light-primary' : ''); ?>">
                                                    <?php echo e($value->max_users); ?>
                                    ...
                                    <div class="card bg-dark shadow-none mb-0">
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex  align-items-center ">
                                                <img src="<?php echo e($logo . '/' . (!empty($value->testimonials_user_avtar) ? $value->testimonials_user_avtar : 'avatar.png')); ?>"
        ...
        <div class="footer-row">
            ...
            <div class="ftr-col">
                <ul class="list-unstyled">
                    ...
                    <?php if(is_array(json_decode($settings['menubar_page'])) || is_object(json_decode($settings['menubar_page']))): ?>
                        <?php $__currentLoopData = json_decode($settings['menubar_page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($value->footer == 'on' && $value->template_name == 'page_content'): ?>
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="<?php echo e(route('custom.page', $value->page_slug)); ?>"><?php echo e($value->menubar_page_name); ?></a>
                                </li>
                            <?php elseif($value->footer == 'on' && $value->template_name == 'page_url'): ?>
                                <li class="nav-item">
                                    <a class="nav-link" target="_blank"
                                        href="<?php echo e($value->page_url); ?>"><?php echo e($value->menubar_page_name); ?></a>
                                </li>
...
<?php /**PATH C:\xampp\htdocs\store\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>