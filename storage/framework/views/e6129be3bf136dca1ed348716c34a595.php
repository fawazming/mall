...
<div class="modal-body">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group col-md-12">
                    ...
                    <?php echo Form::number('price', $plan->price ?? 0, [
                        'class' => 'form-control',
                        'id' => 'monthly_price',
                        'min' => '0',
                        'step' => '0.01',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <?php echo Form::text('max_stores', null, [
                'class' => 'form-control',
                'id' => 'max_stores',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <?php echo Form::text('max_products', null, [
                'class' => 'form-control',
                'id' => 'max_products',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <?php echo Form::text('max_users', null, [
                'class' => 'form-control',
                'id' => 'max_users',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group col-md-12">
                <?php echo e(Form::text('storage_limit', null, ['class' => 'form-control', 'id' => 'storage_limit', 'placeholder' => __('Enter Max Storage Limit'), 'required' => 'required'])); ?>
    ...
    <div class="col-6">
        <div class="custom-control form-switch pt-2">
            <input type="checkbox" class="form-check-input" name="pwa_store" id="pwa_store"
                <?php echo e($plan['pwa_store'] == 'on' ? 'checked=checked' : ''); ?>>
            <label class="custom-control-label form-check-label"
    ...
    <?php if($plan->id != 1): ?>
        <div class="col-md-6 mt-2">
            <div class="custom-control form-switch pt-2">
                <input type="checkbox" class="form-check-input" name="trial" value="1" id="trial" <?php echo e($plan['trial'] == 'on' ?' checked ':''); ?>>
                <label class="custom-control-label form-check-label"
                    for="trial"><?php echo e(__('Trial is enable(on/off)')); ?></label>
            </div>
        </div>
        <div class="col-md-6 <?php echo e($plan['trial'] == 'on' ?'  ':'d-none'); ?> plan_div mt-2">
            <div class="form-group">
                <?php echo e(Form::number('trial_days',null, ['class' => 'form-control', 'id' => 'trial_days' , 'placeholder' => __('Enter Trial days')])); ?>
...
</script><?php /**PATH C:\xampp\htdocs\store\resources\views/plans/edit.blade.php ENDPATH**/ ?>