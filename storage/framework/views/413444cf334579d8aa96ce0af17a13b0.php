                                        ...
                                        <div class="form-group mb-0">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary"
                                                    ...
                                                    <?php echo e($settings['topbar_status'] == 'on' ? 'checked="checked"' : ''); ?>>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <?php echo e(Form::textarea('topbar_notification_msg', $settings['topbar_notification_msg'], ['class' => 'form-control summernote', 'id' => 'classic-editor', 'required' => 'required'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\store\Modules/LandingPage\Resources/views/landingpage/topbar.blade.php ENDPATH**/ ?>